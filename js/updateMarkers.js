  ...
  var countryData=[  
    {
      ...
      "amlCft":["Partial","Argentina issued UIF Resolution 300 in 2014 to create reporting obligations for financial institutions on 'operations performed with virtual coins'. <br/>General Resolution AFIP 4614/2019 requires giving information to the Federal Administration of Public Revenues (AFIP) on transactions that include virtual accounts, digital wallets and service providers. The AFIP uses this information to monitor the development of the digital asset ecosystem as well as to collect taxes on these transactions. <br/>Argentina may revise its anti-money laundering law to include a registry for DASPs. "],
      ...
      "costumerAwareness":["Proposed", "The purpose of advertisement regulation is to educate potential users of digital assets and to protect investors from falling into fake and ponzi schemes based on digital assets."],
    ...
    },
    {
      ...
      "capitalControls":["Proposed","While South Korea controls capital flows through the Foreign Exchange Transactions Act, there is no guidance on how cryptoassets fit within this framework. <br/>In practice, banks do not process cross-border transactions that would fall foul of FETA. "],
